...
public class ParticleEvents {
    ...
    private List<Vec3i> getLoationsOnEdge(Vec3i P1, Vec3i P2, Vec3i P3) {
        ...
        getPoints(particlePoints, 24, closestPoint, isOnX, false, cornerA, negativePassed);
        getPoints(particlePoints, 24, closestPoint, isOnX, true, cornerB, negativePassed);

        return particlePoints;
    }

    private void getPoints(List<Vec3i> points, int amount, Vec3i closestPoint, boolean isOnX, boolean isNegative, Vec3i corner, boolean negativePassed) {
