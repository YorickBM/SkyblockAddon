...
public class JoinIslandOverviewHandler extends ServerOnlyHandler<IslandData> {
    protected JoinIslandOverviewHandler(int syncId, Inventory playerInventory, int rows, IslandData data) {
